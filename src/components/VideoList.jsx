      ...
      <div className="bg-[#0d2a38] rounded-lg overflow-hidden">
        ...
        <div className="p-3 flex">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-[#00ed64] text-sm font-medium leading-tight line-clamp-1 mb-1">
              {title}
            </h3>
            <div className="flex items-center text-xs text-gray-400 space-x-0.5">
              <span>{channelName}</span>
              <span className="scale-75">•</span>
              {/* Smaller dot using scale */}
