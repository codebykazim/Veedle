      ...
      >
        <div className="sticky top-0 bg-[#072331] border-b border-[#1e3a47] p-4 flex justify-between items-center z-10">
          <div>
            ...
            <p className="text-sm text-gray-400">Make changes to your video details</p>
          </div>
          <X size={24} onClick={handleClosePopUp} className="text-gray-400 hover:text-white cursor-pointer" />
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 p-6">
          <div>
            <GetImagePreview
              ...
              cameraIcon
              cameraSize={30}
              className={"w-full h-64 object-cover rounded-lg border border-[#1e3a47]"}
              image={thumbnail}
            />
